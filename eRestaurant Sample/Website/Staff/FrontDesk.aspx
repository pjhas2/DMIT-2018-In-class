    ...
    <div class="row col-md-12">
        ...
        <div class="pull-right col-md-5">
            <details open>
                ...
                <asp:ObjectDataSource runat="server" ID="ReservationDataSource" OldValuesParameterFormatString="original_{0}" SelectMethod="ReservationByTime" TypeName="eRestaurant.BLL.SeatingController">
                    <SelectParameters>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="WalkInSeatingPanel" runat="server" CssClass="input-group input-group-sm" Visible="<%# ! Item.Taken %>">
                                    ...
                                    <span class="input-group-addon">
                                        <asp:DropDownList ID="WaiterList" runat="server" CssClass="selectpicker" AppendDataBoundItems="true" DataSourceID="WaiterDataSource" DataTextField="FullName" DataValueField="WaiterID">
